...
INSERT INTO states (id, name, "iso_3166-2") VALUES
(1, 'Amazonas', 'VE-X'),
(2, 'Anzoátegui', 'VE-B'),
(3, 'Apure', 'VE-C'),
(4, 'Aragua', 'VE-D'),
...
INSERT INTO parishes (id, municipality_id, name) VALUES
(1, 1, 'Alto Orinoco'),
...
ALTER TABLE cities
  ADD CONSTRAINT states_ibfk_1 FOREIGN KEY (state_id) REFERENCES states (id) ON DELETE CASCADE ON UPDATE CASCADE;
