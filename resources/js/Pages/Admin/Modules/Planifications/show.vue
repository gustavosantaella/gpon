<template>
  ...
  <Dashboard>
      ...
      <div class="row">
        ...
        <span
          class="
            ...
            align-items-center
          "
          :class="this.setStyleStatus()"
          >{{ this.planification.status }}</span
        >
      </div>
    ...
    <div v-else><div class="alert alert-warning p-3">Sin actividades</div></div>
  </Dashboard>
</template>
  ...
  methods: {
    ...
    approvedProject(approved, object_id) {
      this.action(
        this,
        "post",
        route("admin.modules.planificaciones.approved", {
          planificacione: object_id,
        }),
        {
          approved,
        }
