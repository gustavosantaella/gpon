                        ...
                        >
                            <template v-slot:modalUser>
                                ...
                                >
                                    <template v-slot:content>
                                        <div class="mb-3">
                                            <label for="users">Asignar usuario a la gerencia
                                                {{ this.gerencia.name }}</label>
                                            <select required='true' name="user_id" v-model='this.user.user_id'
                                                    id="users" class="form-control">
                                                <option v-for='user in this.managementUsers' :value="user.id"
