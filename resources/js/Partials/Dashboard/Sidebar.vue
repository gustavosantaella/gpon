            ...
            <div class="nav">
                ...
                <div v-show="true ||$page.props.flash.userManagement">
                    ...
                    <nav-link
                        ...
                        "
                        :navlink="false"
                        :href="route('admin.modules.planificaciones.index')"
                    >
                        <div class="sb-nav-link-icon">
                    ...
                    <nav-link
                        ...
                        :navlink="false"
                        :href="route('admin.modules.fibra-optica.index')"
                    >
                        <div class="sb-nav-link-icon">
                            <i class="fas fa-chart-area"></i>
                        </div>
                    ...
                    <nav-link
                        ...
                        "
                        :navlink="false"
                        :href="route('admin.modules.red-local.index')"
                    >
                        <div class="sb-nav-link-icon">
                            <i class="fas fa-chart-area"></i>
                        </div>
                    ...
                    <nav-link
                        ...
                        "
                        :navlink="false"
                        :href="route('admin.modules.energia.index')"
                    >
                        <div class="sb-nav-link-icon">
                            <i class="fas fa-chart-area"></i>
                        </div>
                    ...
                    <nav-link
                        ...
                        "
                        :navlink="false"
                        :href="route('admin.modules.infraestructura.index')"
                    >
                        <div class="sb-nav-link-icon">
                            <i class="fas fa-chart-area"></i>
                        </div>
                    ...
                    <nav-link
                        ...
                        :navlink="false"
                        :href="route('admin.modules.construcciones.index')"
                    >
                        <div class="sb-nav-link-icon">
                            <i class="fas fa-chart-area"></i>
                        </div>
                ...
                <nav-link
                   v-show="this.hasRolesOrPermissions(
                                'listar modelos|agregar modelos|editar modelos|eliminar modelos',
                                'user',
                                'permissions'
                            )"
                 :navlink="false" :href="route('admin.modelos.index')">
                    <div class="sb-nav-link-icon">
                        <i class="fas fa-chart-area"></i>
                    </div>
                    Modelos
                ...
                <nav-link
                    :navlink="false"
                    :href="route('admin.gerencias.index')"
                >
                    <div class="sb-nav-link-icon">
                        <i class="fas fa-chart-area"></i>
                    </div>
